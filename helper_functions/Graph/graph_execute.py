...
def Plot_graph_series(stream, prediction_vector, detections, n, alarms=None,  delays=None, false_alarms=None, execution_time=None, RMSError=None, hitRatio=None, name=None):
    ...
    # graph1.annotate(desc, (0,0), (-60, -40), xycoords='axes fraction', textcoords='offset points', va='top')
    ...
    graph1.legend(loc='upper left', ncol=1, fancybox=True, shadow=True)
...
def plotGraphError(stream, detections, error_stream_vector, n, name):
    ...
    figure2.subplots_adjust(bottom=0.1)
    ...
    # grafico2.annotate(desc, (0,0), (-60, -40), xycoords='axes fraction', textcoords='offset points', va='top')
    ...
    plt.ylabel('AE')
    plt.xlabel('Index')
    grafico2.legend(loc='upper left', ncol=1, fancybox=True, shadow=True)
